...
namespace Garage2._5.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,RegistrationNumber,Color,Make,Model,Wheels,IsDeleted,MemberId,VehicleTypeId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,RegistrationNumber,Color,Make,Model,Wheels,IsDeleted,MemberId,VehicleTypeId")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
